...
const PatientConsent = () => {
    return (
        <section>
            <Container>
                <h1 className='text-[#8BC34A] text-[48px] font-bold pb-[10px]'>Patient Consent <span className='text-[#494949]'>Disclaimer</span></h1>
                ...
                <div className='custom-border py-[30px]  '>
                    <h2 className='font-bold text-[24px] text-[#8BC34A] pb-[10px]'>1- Use of AI-Powered Services</h2>
                    <p className='text-[#4E4E4E] text-[24px]  pt-[20px] leading-[37px]'>By using this app, you acknowledge that its primary features are powered by artificial
                ...
                {/* 2- Community Support */}
                <div className='custom-border py-[30px]  '>
                    <h2 className='font-bold text-[24px] text-[#8BC34A] pb-[10px]'>2- Community Support</h2>
                    <p className='text-[#4E4E4E] text-[24px]  pt-[20px] leading-[37px]'>The app includes a community support feature designed to foster peer engagement. While we
                ...
                <div className='custom-border py-[30px]  '>
                    <h2 className='font-bold text-[24px] text-[#8BC34A] pb-[10px]'>3- Escalation to Licensed Professionals</h2>
                    <p className='text-[#4E4E4E] text-[24px] font-medium pt-[20px]'>The app has defined escalation policies:</p>
                  ...
                  <div className='custom-border py-[30px]  '>
                    <h2 className='font-bold text-[24px] text-[#8BC34A] pb-[10px]'>4- Limitations and Responsibilities</h2>
                    <p className='text-[#4E4E4E] text-[24px] font-medium pt-[20px]'>The app has defined escalation policies:</p>
                    <ul className='info-list flex flex-col gap-[14px] list-disc '>
                        <li className=''>
                ...
                <div className='custom-border py-[30px]  '>
                    <h2 className='font-bold text-[24px] text-[#8BC34A] pb-[10px]'>5- Emergency Situations</h2>
                    <p className='text-[#4E4E4E] text-[24px]  pt-[20px] leading-[37px]'>The app is not intended for use in emergency situations. If you are in crisis or need immediate 
                    assistance, please contact local emergency services or a crisis hotline in your area.
                    </p>
                </div>
              {/*6- Consent to Participate*/}
              <div className='custom-border py-[30px]  '>
                    <h2 className='font-bold text-[24px] text-[#8BC34A] pb-[10px]'>6- Consent to Participate</h2>
                    <p className='text-[#4E4E4E] text-[24px] font-medium pt-[20px]'>By creating an account and using the app, you consent to:</p>
                    <ul className='info-list flex flex-col gap-[14px] list-disc '>
                        <li className=''>
