            ...
            <Container className='py-[60px]'>
                <Row >
                    <Col lg={12} md={12} xs={12} className='flex flex-col relative description-part gap-3'>
                        <Image src={mobileImg} alt='mood' className='mobileleft-img hover:scale-105 transition-all ease-in-3s' width={358} height={626}/>
                        <div className='mble-left-description max-h-[324px] min-h-[324px] flex flex-col py-[60px] justify-center gap-3 rounded-[18px] bg-[rgba(217,_217,_217,_0.10)] [box-shadow:26.233px_-26.233px_26.233px_0px_rgba(165,_165,_165,_0.10)_inset,_-26.233px_26.233px_26.233px_0px_rgba(255,_255,_255,_0.10)_inset] backdrop-filter backdrop-blur-[26.233333587646484px]'>
